...
Version 1.3.2, last updated 8 March 2010\\
...
{\tt -sg}& Use this option to skip processing genes that do not have taxa of interest. Use {\tt -p} option to specify taxa of interest. \\
...
\end{verbatim}
The above command spits out an error message if some genes do not have all taxa of interest. If you would like bucky to skip such genes and analyze the rest, {\tt -sg} can be used. Example:
\begin{verbatim}
...
\smallskip {\tt mbsum} recognizes Mac-style line breaks as well as
